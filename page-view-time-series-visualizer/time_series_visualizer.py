...
# I user this path to read the data because is where i have the csv file
df = pd.read_csv('page-view-time-series-visualizer/fcc-forum-pageviews.csv', index_col='date', parse_dates=True)
